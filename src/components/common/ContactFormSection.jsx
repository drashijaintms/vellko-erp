...
export default function ContactFormSection({ title, subtitle, showHeading = true, customClass }) {
  ...
  const handleSubmit = async (e) => {
    ...
    const pageurl = typeof window !== 'undefined' ? window.location.href : 'https://vellkoerp.com/';
  ...
  return (
    <section className={customClass || "contact-form-section-wrapper"} id="contact-form">
      <div className="contact-page-container">
        {showHeading && (
          <div className="contact-section-header">
            <h2 className="contact-section-main-heading">
              {title || <>Get in Touch with Our <span className="red-highlight">ERP Experts</span></>}
            </h2>
            <p className="contact-section-sub-desc">
              {subtitle || "Have questions or ready to transform your business? Fill out the form below and our team will get back to you promptly."}
            </p>
          </div>
        )}
        ...
        <div className="contact-main-card animate-fade-in">
          ...
          <div className="contact-left-col">
            <form onSubmit={handleSubmit}>
              ...
              <input type="hidden" name="pageurl" value={typeof window !== 'undefined' ? window.location.href : 'https://vellkoerp.com/'} />
